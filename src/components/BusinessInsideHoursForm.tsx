...
import "./BusinessInsideHoursForm.css";

interface BusinessInsideHoursFormProps {
  businessId: string;
}
...
export default function BusinessInsideHoursForm({
  businessId,
}: BusinessInsideHoursFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.from("business_inside_hours").insert([
      {
  ...
  return (
    <form onSubmit={handleSubmit} className="business-inside-hours-form">

...
ALTER FUNCTION "public"."update_business_inside_categories_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_business_inside_hours_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_business_inside_hours_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_business_inside_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_business_inside_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_business_outside_categories_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_business_outside_categories_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_business_outside_hours_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_business_outside_hours_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_business_outside_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_business_outside_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_houses_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_houses_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_location_type_associations_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_location_type_associations_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_main_location_id"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    IF NEW.is_main THEN
        -- Met à jour main_location_id dans profiles
        UPDATE public.profiles
        SET main_location_id = NEW.location_id
...
ALTER FUNCTION "public"."update_public_poi_categories_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_public_poi_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_public_poi_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_service_categories_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_service_categories_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_service_hours_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_service_hours_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."business_inside" (
...
ALTER TABLE "public"."business_inside" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."business_inside_categories" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
...
ALTER TABLE "public"."business_inside_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."business_inside_hours" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "business_id" "uuid" NOT NULL,
    "day_of_week" smallint NOT NULL,
    "opening_time" time without time zone,
    "closing_time" time without time zone,
    "has_break" boolean DEFAULT false NOT NULL,
    "break_start" time without time zone,
    "break_end" time without time zone,
    "is_closed" boolean DEFAULT false NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    CONSTRAINT "business_inside_hours_day_of_week_check" CHECK ((("day_of_week" >= 0) AND ("day_of_week" <= 6))),
    CONSTRAINT "valid_business_hours" CHECK (((("is_closed" = true) AND ("opening_time" IS NULL) AND ("closing_time" IS NULL) AND ("break_start" IS NULL) AND ("break_end" IS NULL)) OR (("is_closed" = false) AND ((("has_break" = false) AND ("opening_time" IS NOT NULL) AND ("closing_time" IS NOT NULL) AND ("opening_time" < "closing_time")) OR (("has_break" = true) AND ("opening_time" IS NOT NULL) AND ("closing_time" IS NOT NULL) AND ("break_start" IS NOT NULL) AND ("break_end" IS NOT NULL) AND ("opening_time" < "break_start") AND ("break_start" < "break_end") AND ("break_end" < "closing_time"))))))
);


ALTER TABLE "public"."business_inside_hours" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."business_outside" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "location_id" "uuid" NOT NULL,
    "owner_id" "uuid" NOT NULL,
    "business_name" "text" NOT NULL,
...
ALTER TABLE "public"."business_outside" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."business_outside_categories" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
...
ALTER TABLE "public"."business_outside_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."business_outside_hours" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "business_id" "uuid" NOT NULL,
    "day_of_week" smallint NOT NULL,
    "opening_time" time without time zone,
    ...
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    CONSTRAINT "business_outside_hours_day_of_week_check" CHECK ((("day_of_week" >= 0) AND ("day_of_week" <= 6))),
    CONSTRAINT "valid_business_outside_hours" CHECK (((("is_closed" = true) AND ("opening_time" IS NULL) AND ("closing_time" IS NULL) AND ("break_start" IS NULL) AND ("break_end" IS NULL)) OR (("is_closed" = false) AND ((("has_break" = false) AND ("opening_time" IS NOT NULL) AND ("closing_time" IS NOT NULL) AND ("opening_time" < "closing_time")) OR (("has_break" = true) AND ("opening_time" IS NOT NULL) AND ("closing_time" IS NOT NULL) AND ("break_start" IS NOT NULL) AND ("break_end" IS NOT NULL) AND ("opening_time" < "break_start") AND ("break_start" < "break_end") AND ("break_end" < "closing_time"))))))
);
...
CREATE TABLE IF NOT EXISTS "public"."houses" (
    ...
    "location_id" "uuid" NOT NULL,
    "owner_id" "uuid" NOT NULL,
    "icon_url" "text" DEFAULT 'https://example.com/default-house-icon.png'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "deleted_at" timestamp with time zone
);
...
CREATE TABLE IF NOT EXISTS "public"."houses_available_icons" (
    "id" integer NOT NULL,
...
ALTER TABLE "public"."houses_available_icons" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."houses_available_icons_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."houses_available_icons_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."houses_available_icons_id_seq" OWNED BY "public"."houses_available_icons"."id";
...
ALTER TABLE "public"."location_type_associations" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."location_types" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    CONSTRAINT "location_types_name_check" CHECK (("name" = ANY (ARRAY['house'::"text", 'service'::"text", 'business_inside'::"text", 'business_outside'::"text", 'public_poi'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "email" "text",
    "occupation" "text",
    "profile_picture_url" "text" DEFAULT 'https://wlrrruemchacgyypexsu.supabase.co/storage/v1/object/sign/avatars/ggv-100.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJhdmF0YXJzL2dndi0xMDAucG5nIiwiaWF0IjoxNzQyMzg1NzM4LCJleHAiOjE5MDAwNjU3Mzh9.Gim-LkcsEnVmu25JTAxi3mBoOYi_pEOQ7A8skjhhvHU'::"text",
    "description" "text",
    "facebook" "text",
    "messenger" "text",
    "whatsapp" "text",
    ...
    "business_inside_location" "uuid",
    "has_a_business_outside" boolean DEFAULT false,
    "business_outside_location" "uuid",
...
CREATE TABLE IF NOT EXISTS "public"."public_poi" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "location_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."public_poi" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."public_poi_categories" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
...
ALTER TABLE "public"."public_poi_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."public_poi_hours" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "location_id" "uuid" NOT NULL,
    "poi_name" "text" NOT NULL,
    "description" "text",
    ...
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    CONSTRAINT "public_poi_hours_day_of_week_check" CHECK ((("day_of_week" >= 0) AND ("day_of_week" <= 6))),
    CONSTRAINT "valid_poi_hours" CHECK (((("is_closed" = true) AND ("opening_time" IS NULL) AND ("closing_time" IS NULL) AND ("break_start" IS NULL) AND ("break_end" IS NULL)) OR (("is_closed" = false) AND ((("has_break" = false) AND ("opening_time" IS NOT NULL) AND ("closing_time" IS NOT NULL) AND ("opening_time" < "closing_time")) OR (("has_break" = true) AND ("opening_time" IS NOT NULL) AND ("closing_time" IS NOT NULL) AND ("break_start" IS NOT NULL) AND ("break_end" IS NOT NULL) AND ("opening_time" < "break_start") AND ("break_start" < "break_end") AND ("break_end" < "closing_time"))))))
);


ALTER TABLE "public"."public_poi_hours" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."service_hours" (
    ...
    CONSTRAINT "valid_hours" CHECK (((("is_closed" = true) AND ("opening_time" IS NULL) AND ("closing_time" IS NULL) AND ("break_start" IS NULL) AND ("break_end" IS NULL)) OR (("is_closed" = false) AND ((("has_break" = false) AND ("opening_time" IS NOT NULL) AND ("closing_time" IS NOT NULL) AND ("opening_time" < "closing_time")) OR (("has_break" = true) AND ("opening_time" IS NOT NULL) AND ("closing_time" IS NOT NULL) AND ("break_start" IS NOT NULL) AND ("break_end" IS NOT NULL) AND ("opening_time" < "break_start") AND ("break_start" < "break_end") AND ("break_end" < "closing_time"))))))
);
...
CREATE TABLE IF NOT EXISTS "public"."services" (
    ...
    "description" "text",
    "has_custom_hours" boolean DEFAULT false NOT NULL,
    "default_opening_time" time without time zone,
    "default_closing_time" time without time zone,
    "default_has_break" boolean DEFAULT false NOT NULL,
    "default_break_start" time without time zone,
    "default_break_end" time without time zone,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "deleted_at" timestamp with time zone,
    "category_id" "uuid"
...
ALTER TABLE ONLY "public"."houses_available_icons" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."houses_available_icons_id_seq"'::"regclass");



ALTER TABLE ONLY "public"."business_inside_categories"
    ADD CONSTRAINT "business_inside_categories_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."business_inside_categories"
    ADD CONSTRAINT "business_inside_categories_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."business_inside_hours"
    ADD CONSTRAINT "business_inside_hours_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."business_inside"
    ADD CONSTRAINT "business_inside_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."business_outside_categories"
    ADD CONSTRAINT "business_outside_categories_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."business_outside_categories"
    ADD CONSTRAINT "business_outside_categories_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."business_outside_hours"
    ADD CONSTRAINT "business_outside_hours_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."business_outside"
    ADD CONSTRAINT "business_outside_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."location_type_associations"
    ADD CONSTRAINT "location_type_associations_pkey" PRIMARY KEY ("location_id", "type_id");
...
ALTER TABLE ONLY "public"."profile_location_associations"
    ADD CONSTRAINT "profile_location_associations_pkey" PRIMARY KEY ("profile_id", "location_id");
...
ALTER TABLE ONLY "public"."public_poi_categories"
    ADD CONSTRAINT "public_poi_categories_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."public_poi_categories"
    ADD CONSTRAINT "public_poi_categories_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."public_poi_hours"
    ADD CONSTRAINT "public_poi_hours_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."public_poi"
    ADD CONSTRAINT "public_poi_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_location_type_associations_type_id" ON "public"."location_type_associations" USING "btree" ("type_id");
...
CREATE OR REPLACE TRIGGER "update_business_inside_categories_updated_at" BEFORE UPDATE ON "public"."business_inside_categories" FOR EACH ROW EXECUTE FUNCTION "public"."update_business_inside_categories_updated_at"();



CREATE OR REPLACE TRIGGER "update_business_inside_hours_updated_at" BEFORE UPDATE ON "public"."business_inside_hours" FOR EACH ROW EXECUTE FUNCTION "public"."update_business_inside_hours_updated_at"();



CREATE OR REPLACE TRIGGER "update_business_inside_updated_at" BEFORE UPDATE ON "public"."business_inside" FOR EACH ROW EXECUTE FUNCTION "public"."update_business_inside_updated_at"();



CREATE OR REPLACE TRIGGER "update_business_outside_categories_updated_at" BEFORE UPDATE ON "public"."business_outside_categories" FOR EACH ROW EXECUTE FUNCTION "public"."update_business_outside_categories_updated_at"();



CREATE OR REPLACE TRIGGER "update_business_outside_hours_updated_at" BEFORE UPDATE ON "public"."business_outside_hours" FOR EACH ROW EXECUTE FUNCTION "public"."update_business_outside_hours_updated_at"();



CREATE OR REPLACE TRIGGER "update_business_outside_updated_at" BEFORE UPDATE ON "public"."business_outside" FOR EACH ROW EXECUTE FUNCTION "public"."update_business_outside_updated_at"();
...
CREATE OR REPLACE TRIGGER "update_public_poi_categories_updated_at" BEFORE UPDATE ON "public"."public_poi_categories" FOR EACH ROW EXECUTE FUNCTION "public"."update_public_poi_categories_updated_at"();



CREATE OR REPLACE TRIGGER "update_public_poi_updated_at" BEFORE UPDATE ON "public"."public_poi" FOR EACH ROW EXECUTE FUNCTION "public"."update_public_poi_updated_at"();



CREATE OR REPLACE TRIGGER "update_public_poi_updated_at" BEFORE UPDATE ON "public"."public_poi_hours" FOR EACH ROW EXECUTE FUNCTION "public"."update_public_poi_updated_at"();



CREATE OR REPLACE TRIGGER "update_service_categories_updated_at" BEFORE UPDATE ON "public"."service_categories" FOR EACH ROW EXECUTE FUNCTION "public"."update_service_categories_updated_at"();



CREATE OR REPLACE TRIGGER "update_service_hours_updated_at" BEFORE UPDATE ON "public"."service_hours" FOR EACH ROW EXECUTE FUNCTION "public"."update_service_hours_updated_at"();



CREATE OR REPLACE TRIGGER "update_services_updated_at" BEFORE UPDATE ON "public"."services" FOR EACH ROW EXECUTE FUNCTION "public"."update_services_updated_at"();



ALTER TABLE ONLY "public"."business_inside_hours"
    ADD CONSTRAINT "business_inside_hours_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_inside"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."business_inside"
    ADD CONSTRAINT "business_inside_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."business_inside"
    ADD CONSTRAINT "business_inside_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."business_outside_hours"
    ADD CONSTRAINT "business_outside_hours_business_id_fkey" FOREIGN KEY ("business_id") REFERENCES "public"."business_outside"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."business_outside"
    ADD CONSTRAINT "business_outside_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."business_outside"
    ADD CONSTRAINT "business_outside_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."houses"
    ADD CONSTRAINT "houses_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."profile_location_associations"
    ADD CONSTRAINT "profile_location_associations_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."profile_location_associations"
    ADD CONSTRAINT "profile_location_associations_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."public_poi_hours"
    ADD CONSTRAINT "public_poi_hours_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."public_poi"
    ADD CONSTRAINT "public_poi_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."service_hours"
    ADD CONSTRAINT "service_hours_service_id_fkey" FOREIGN KEY ("service_id") REFERENCES "public"."services"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admins have full access to profiles" ON "public"."profiles" TO "authenticated" USING (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "All users can read POI" ON "public"."public_poi_hours" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can read business hours" ON "public"."business_inside_hours" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read business outside hours" ON "public"."business_outside_hours" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read business_inside" ON "public"."business_inside" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read business_inside_categories" ON "public"."business_inside_categories" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read business_outside" ON "public"."business_outside" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read business_outside_categories" ON "public"."business_outside_categories" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read houses" ON "public"."houses" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read location_type_associations" ON "public"."location_type_associations" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can read public profiles" ON "public"."profiles" FOR SELECT TO "authenticated" USING (("is_public_profile" = true));



CREATE POLICY "Authenticated users can read public_poi" ON "public"."public_poi" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read public_poi_categories" ON "public"."public_poi_categories" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read service hours" ON "public"."service_hours" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read service_categories" ON "public"."service_categories" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Only admin can create available icons" ON "public"."houses_available_icons" FOR INSERT TO "authenticated" WITH CHECK (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admin can delete available icons" ON "public"."houses_available_icons" FOR DELETE TO "authenticated" USING (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admin can update available icons" ON "public"."houses_available_icons" FOR UPDATE TO "authenticated" USING (("auth"."role"() = 'admin'::"text")) WITH CHECK (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can create POI" ON "public"."public_poi_hours" FOR INSERT TO "authenticated" WITH CHECK (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can create business_inside_categories" ON "public"."business_inside_categories" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
...
CREATE POLICY "Only admins can create location_type_associations" ON "public"."location_type_associations" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Only admins can create locations" ON "public"."locations" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Only admins can create public_poi" ON "public"."public_poi" FOR INSERT TO "authenticated" WITH CHECK (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can create public_poi_categories" ON "public"."public_poi_categories" FOR INSERT TO "authenticated" WITH CHECK (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can create service_categories" ON "public"."service_categories" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Only admins can delete POI" ON "public"."public_poi_hours" FOR DELETE TO "authenticated" USING (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can delete business_inside_categories" ON "public"."business_inside_categories" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Only admins can delete business_outside_categories" ON "public"."business_outside_categories" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Only admins can delete location_type_associations" ON "public"."location_type_associations" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Only admins can delete locations" ON "public"."locations" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Only admins can delete public_poi" ON "public"."public_poi" FOR DELETE TO "authenticated" USING (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can delete public_poi_categories" ON "public"."public_poi_categories" FOR DELETE TO "authenticated" USING (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can delete service_categories" ON "public"."service_categories" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));



CREATE POLICY "Only admins can update POI" ON "public"."public_poi_hours" FOR UPDATE TO "authenticated" USING (("auth"."role"() = 'admin'::"text")) WITH CHECK (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can update block, lot, and coordinates" ON "public"."locations" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
...
CREATE POLICY "Only admins can update business_inside_categories" ON "public"."business_inside_categories" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));
...
CREATE POLICY "Only admins can update business_outside_categories" ON "public"."business_outside_categories" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));
...
CREATE POLICY "Only admins can update location_type_associations" ON "public"."location_type_associations" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));
...
CREATE POLICY "Only admins can update public_poi" ON "public"."public_poi" FOR UPDATE TO "authenticated" USING (("auth"."role"() = 'admin'::"text")) WITH CHECK (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can update public_poi_categories" ON "public"."public_poi_categories" FOR UPDATE TO "authenticated" USING (("auth"."role"() = 'admin'::"text")) WITH CHECK (("auth"."role"() = 'admin'::"text"));



CREATE POLICY "Only admins can update service_categories" ON "public"."service_categories" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'admin'::"text")))));
...
CREATE POLICY "Only associated users can lock/unlock locations" ON "public"."locations" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
  ...
  WHERE (("pla"."location_id" = "locations"."id") AND ("pla"."profile_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profile_location_associations" "pla"
  WHERE (("pla"."location_id" = "locations"."id") AND ("pla"."profile_id" = "auth"."uid"())))));



CREATE POLICY "Only business owners can create hours" ON "public"."business_inside_hours" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."business_inside"
  WHERE (("business_inside"."id" = "business_inside_hours"."business_id") AND ("business_inside"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Only business owners can create outside hours" ON "public"."business_outside_hours" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."business_outside"
  WHERE (("business_outside"."id" = "business_outside_hours"."business_id") AND ("business_outside"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Only business owners can delete hours" ON "public"."business_inside_hours" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."business_inside"
  WHERE (("business_inside"."id" = "business_inside_hours"."business_id") AND ("business_inside"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Only business owners can delete outside hours" ON "public"."business_outside_hours" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."business_outside"
  WHERE (("business_outside"."id" = "business_outside_hours"."business_id") AND ("business_outside"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Only business owners can update hours" ON "public"."business_inside_hours" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."business_inside"
  WHERE (("business_inside"."id" = "business_inside_hours"."business_id") AND ("business_inside"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."business_inside"
  WHERE (("business_inside"."id" = "business_inside_hours"."business_id") AND ("business_inside"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Only business owners can update outside hours" ON "public"."business_outside_hours" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."business_outside"
  WHERE (("business_outside"."id" = "business_outside_hours"."business_id") AND ("business_outside"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."business_outside"
  WHERE (("business_outside"."id" = "business_outside_hours"."business_id") AND ("business_outside"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Only owners can create business_inside" ON "public"."business_inside" FOR INSERT TO "authenticated" WITH CHECK (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can create business_outside" ON "public"."business_outside" FOR INSERT TO "authenticated" WITH CHECK (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can create houses" ON "public"."houses" FOR INSERT TO "authenticated" WITH CHECK (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can create services" ON "public"."services" FOR INSERT TO "authenticated" WITH CHECK (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can delete business_inside" ON "public"."business_inside" FOR DELETE TO "authenticated" USING (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can delete business_outside" ON "public"."business_outside" FOR DELETE TO "authenticated" USING (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can delete houses" ON "public"."houses" FOR DELETE TO "authenticated" USING (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can delete services" ON "public"."services" FOR DELETE TO "authenticated" USING (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can update business_inside" ON "public"."business_inside" FOR UPDATE TO "authenticated" USING (("owner_id" = "auth"."uid"())) WITH CHECK (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can update business_outside" ON "public"."business_outside" FOR UPDATE TO "authenticated" USING (("owner_id" = "auth"."uid"())) WITH CHECK (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can update houses" ON "public"."houses" FOR UPDATE TO "authenticated" USING (("owner_id" = "auth"."uid"())) WITH CHECK (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only owners can update services" ON "public"."services" FOR UPDATE TO "authenticated" USING (("owner_id" = "auth"."uid"())) WITH CHECK (("owner_id" = "auth"."uid"()));



CREATE POLICY "Only service owners can create hours" ON "public"."service_hours" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."services"
  WHERE (("services"."id" = "service_hours"."service_id") AND ("services"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Only service owners can delete hours" ON "public"."service_hours" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."services"
  WHERE (("services"."id" = "service_hours"."service_id") AND ("services"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Only service owners can update hours" ON "public"."service_hours" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."services"
  WHERE (("services"."id" = "service_hours"."service_id") AND ("services"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."services"
  WHERE (("services"."id" = "service_hours"."service_id") AND ("services"."owner_id" = "auth"."uid"())))));
...
ALTER TABLE "public"."business_inside_categories" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."business_inside_hours" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."update_business_inside_hours_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_business_inside_hours_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_business_inside_hours_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_business_inside_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_business_inside_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_business_inside_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_business_outside_categories_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_business_outside_categories_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_business_outside_categories_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_business_outside_hours_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_business_outside_hours_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_business_outside_hours_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_business_outside_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_business_outside_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_business_outside_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_houses_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_houses_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_houses_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_location_type_associations_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_location_type_associations_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_location_type_associations_updated_at"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_public_poi_categories_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_public_poi_categories_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_public_poi_categories_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_public_poi_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_public_poi_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_public_poi_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_service_categories_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_service_categories_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_service_categories_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_service_hours_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_service_hours_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_service_hours_updated_at"() TO "service_role";
...
GRANT ALL ON TABLE "public"."business_inside" TO "anon";
GRANT ALL ON TABLE "public"."business_inside" TO "authenticated";
GRANT ALL ON TABLE "public"."business_inside" TO "service_role";



GRANT ALL ON TABLE "public"."business_inside_categories" TO "anon";
GRANT ALL ON TABLE "public"."business_inside_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."business_inside_categories" TO "service_role";



GRANT ALL ON TABLE "public"."business_inside_hours" TO "anon";
GRANT ALL ON TABLE "public"."business_inside_hours" TO "authenticated";
GRANT ALL ON TABLE "public"."business_inside_hours" TO "service_role";



GRANT ALL ON TABLE "public"."business_outside" TO "anon";
GRANT ALL ON TABLE "public"."business_outside" TO "authenticated";
GRANT ALL ON TABLE "public"."business_outside" TO "service_role";



GRANT ALL ON TABLE "public"."business_outside_categories" TO "anon";
GRANT ALL ON TABLE "public"."business_outside_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."business_outside_categories" TO "service_role";



GRANT ALL ON TABLE "public"."business_outside_hours" TO "anon";
GRANT ALL ON TABLE "public"."business_outside_hours" TO "authenticated";
GRANT ALL ON TABLE "public"."business_outside_hours" TO "service_role";
...
GRANT ALL ON TABLE "public"."houses_available_icons" TO "anon";
GRANT ALL ON TABLE "public"."houses_available_icons" TO "authenticated";
GRANT ALL ON TABLE "public"."houses_available_icons" TO "service_role";



GRANT ALL ON SEQUENCE "public"."houses_available_icons_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."houses_available_icons_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."houses_available_icons_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."profile_location_associations" TO "anon";
GRANT ALL ON TABLE "public"."profile_location_associations" TO "authenticated";
GRANT ALL ON TABLE "public"."profile_location_associations" TO "service_role";
...
GRANT ALL ON TABLE "public"."public_poi" TO "anon";
GRANT ALL ON TABLE "public"."public_poi" TO "authenticated";
GRANT ALL ON TABLE "public"."public_poi" TO "service_role";



GRANT ALL ON TABLE "public"."public_poi_categories" TO "anon";
GRANT ALL ON TABLE "public"."public_poi_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."public_poi_categories" TO "service_role";



GRANT ALL ON TABLE "public"."public_poi_hours" TO "anon";
GRANT ALL ON TABLE "public"."public_poi_hours" TO "authenticated";
GRANT ALL ON TABLE "public"."public_poi_hours" TO "service_role";

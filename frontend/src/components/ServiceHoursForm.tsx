...
export default function ServiceHoursForm({ serviceId }: ServiceHoursFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="service-hours-form">
